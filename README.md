...
- **Current release: v2.4.1** — two-tier invocation (full/skip, footprint rounds merged into full with footprint discipline); schema stable (`memory/v2/` v2.0.0), actively maintained. Also on [PyPI](https://pypi.org/project/personal-understanding/).
